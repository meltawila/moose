...
{
  if (T < 11 || T > 3700)
    flagInvalidSolution("Specific heat out of bounds for the Tungsten temperature computation");
  if (T < 293)
  return _cA0 * std::pow(T / 1000, 3.030) / (1 + _cA1 * T / 1000 + _cA2 * Utility::pow<2>(T / 1000) + _cA3 * Utility::pow<3>(T / 1000));
  else
...
ThermalTungstenProperties::cp_from_T(const Real & T, Real & cp, Real & dcp_dT) const
{
  ...
  cp = cp_from_T(T);
  if (T < 293) {
    dcp_dT = 1 / 1000 * (_cA0 * _cN * std::pow(T / 1000, 3.030 - 1) * (1 + _cA1 * T / 1000 + _cA2 * Utility::pow<2>(T / 1000) + _cA3 * Utility::pow<3>(T / 1000)) 
            - _cA0 * std::pow(T / 1000, 3.030) * (_cA1 + 2 * _cA2 * T / 1000 + 3 * _cA3 * Utility::pow<2>(T / 1000)))
...
{
  if (T < 1 || T > 3653)
    flagInvalidSolution("Thermal conductivity out of bounds for the Tungsten temperature computation");
  if (T < 55)
  return _kA0 * std::pow(T / 1000, 8.740e-01) / (1 + _kA1 * T / 1000 + _kA2 * Utility::pow<2>(T / 1000) + _kA3 * Utility::pow<3>(T / 1000));
  else
...
ThermalTungstenProperties::k_from_T(const Real & T, Real & k, Real & dk_dT) const
{
 if (T < 1 || T > 3653)
  ...
  k = k_from_T(T);
  if (T < 55) {
    dk_dT = 1/1000 * (_kA0 * _kN * std::pow(T / 1000, 8.740e-01 - 1) * (1 + _kA1 * T / 1000 + _kA2 * Utility::pow<2>(T / 1000) + _kA3 * Utility::pow<3>(T / 1000)) 
            - _kA0 * std::pow(T / 1000, 8.740e-01)*(_kA1 + 2 * _kA2 * T / 1000 + 3 * _kA3 * Utility::pow<2>(T / 1000)))
    ...
    dk_dT = 1/1000 * ((_kB1 + 2 * _kB2 * T / 1000 + 3 * _kB3 * Utility::pow<2>(T / 1000)) * (_kC0 + _kC1 * T / 1000 + Utility::pow<2>(T / 1000))
            ...
            / Utility::pow<2>(_kC0+ _kC1 * T / 1000 + Utility::pow<2>(T / 1000));}
}
...
{
 if (T < 5 || T > 3600)
    flagInvalidSolution("density out of bounds for the Tungsten temperature computation");  
  if (T <= 294)
